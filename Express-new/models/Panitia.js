...
class Panitia extends SuperUser{
	...
	daftarPesertaBaru(data, callback){
		console.log("masuk");
		var query = "SELECT nama_mahasiswa, nim_mahasiswa, nama_departemen, nama_lomba, photo_peserta, photo_ktm_peserta FROM peserta join mahasiswa on idmahasiswa_peserta = id_mahasiswa join lomba on idlomba_peserta = id_lomba join departemen on iddepartemen_mahasiswa = id_departemen  WHERE ?";
