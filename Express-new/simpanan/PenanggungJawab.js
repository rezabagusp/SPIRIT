...
class PenanggungJawab extends SuperUser {
	...
	listPeserta(data, callback){
		var query = "SELECT nama_mahasiswa, nim_mahasiswa, photo_peserta, photo_ktm_peserta, status_peserta FROM mahasiswa join peserta on idmahasiswa_peserta = id_mahasiswa join departemen on fkdepartemen_mahasiswa = id_departemen WHERE ? and ?";
